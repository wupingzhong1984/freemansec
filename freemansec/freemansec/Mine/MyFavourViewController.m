...
- (void)viewDidLoad {
    ...
    self.tabCollViewRect = CGRectMake(0, naviBar.maxY, K_UIScreenWidth, 44);
    [self reloadDataWith:[NSArray arrayWithObjects:NSLocalizedString(@"people business live", nil), NSLocalizedString(@"hot video", nil), nil] andSubViewdisplayClasses:[NSArray arrayWithObjects:[MyFavourKindViewController class], [MyFavourKindViewController class], nil] withParams:[NSArray arrayWithObjects:@"0", @"1", nil]];
}
