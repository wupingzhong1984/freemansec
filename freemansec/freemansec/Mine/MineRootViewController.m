...
- (UIView*)naviBarView {
    ...
    UIView *title = [self commNaviTitle:@"个人中心" color:[UIColor whiteColor]];//NSLocalizedString
...
- (void)viewDidLoad {
    ...
    UIImageView *img = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"p3.png"]];
