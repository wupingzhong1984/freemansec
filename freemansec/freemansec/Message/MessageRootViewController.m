...
- (UIView*)naviBarView {
    ...
    UIView *title = [self commNaviTitle:@"消息" color:[UIColor whiteColor]];//NSLocalizedString
...
- (void)viewDidLoad {
    ...
    UIImageView *img = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"p2.png"]];
