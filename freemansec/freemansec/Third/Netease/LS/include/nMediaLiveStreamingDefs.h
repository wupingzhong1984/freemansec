...
typedef struct LSVideoParaCtx
{
    ...
    bool isVideoWaterMarkEnabled;                     //!< 是否打开水印支持.
    bool isVideoFilterOn;                             //!< 是否打开滤镜支持功能.
    bool isQosOn;                                     //!< 是否打开qos功能.
    bool isFrontCameraMirroredPreView;                //!< 是否镜像前置摄像头预览.
    bool isFrontCameraMirroredCode;                   //!< 是否镜像前置摄像头编码.
    bool isOutputRGB;                                 //!< 是否输出RGB数据.
} LSVideoParaCtx;
